              ...
              <div class="sidebar">
                ...
                <div class="sidebar-item recent-posts">
                  <div class="post-item clearfix">
                    <img
                      :src="`${$page.props.asset}/assets/img/blog/blog-recent-1.jpg`"
                      alt=""
                    />
                    <h4>
                      <a href="blog-single.html"
                  ...
                  <div class="post-item clearfix">
                    <img
                      :src="`${$page.props.asset}/assets/img/blog/blog-recent-2.jpg`"
                      alt=""
                    />
                    <h4>
                  ...
                  <div class="post-item clearfix">
                    <img
                      :src="`${$page.props.asset}/assets/img/blog/blog-recent-3.jpg`"
                      alt=""
                    />
                    <h4>
                      <a href="blog-single.html"
                  ...
                  <div class="post-item clearfix">
                    <img
                      :src="`${$page.props.asset}/assets/img/blog/blog-recent-4.jpg`"
                      alt=""
                    />
                    <h4>
                      <a href="blog-single.html"
                  ...
                  <div class="post-item clearfix">
                    <img
                      :src="`${$page.props.asset}/assets/img/blog/blog-recent-5.jpg`"
                      alt=""
                    />
                    <h4>
                      <a href="blog-single.html"

      ...
      <div class="tab-content">
        <div class="tab-pane active show" id="tab-1">
          <div class="row">
            ...
            >
              <img
                :src="`${asset}/assets/img/tabs-1.jpg`"
                alt=""
                class="img-fluid"
              />
            </div>
          ...
          <div class="row">
            <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
              ...
              <ul>
                ...
                <li>
                  <i class="ri-check-double-line"></i> Provident mollitia neque
            ...
            <div class="col-lg-6 order-1 order-lg-2 text-center">
              <img
                :src="`${asset}/assets/img/tabs-2.jpg`"
                alt=""
                class="img-fluid"
              />
            </div>
        ...
        <div class="tab-pane" id="tab-3">
          <div class="row">
            ...
            <div class="col-lg-6 order-1 order-lg-2 text-center">
              <img
                :src="`${asset}/assets/img/tabs-3.jpg`"
                alt=""
                class="img-fluid"
              />
            </div>
        ...
        <div class="tab-pane" id="tab-4">
          <div class="row">
            ...
            <div class="col-lg-6 order-1 order-lg-2 text-center">
              <img
                :src="`${asset}/assets/img/tabs-4.jpg`"
                alt=""
                class="img-fluid"
              />
            </div>

    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item" @click.prevent="toogleNavigation">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="layouts-container.html" class="menu-link"> Container </a>
          </li>
          <li class="menu-item">
            <a href="layouts-fluid.html" class="menu-link">Fluid</a>
          </li>
          <li class="menu-item">
            <a href="layouts-blank.html" class="menu-link">Blank</a>
          </li>
        </ul>
      </li>
